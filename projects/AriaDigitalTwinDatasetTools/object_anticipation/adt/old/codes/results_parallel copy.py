...
distance_counters_threshold = [30]               # Keep objects that exceed this count for distance values below the threshold
...
def run_simulation(parameters):   
    ...
    def main():
       ...
       # Write the results
        with open(os.path.join(results_folder, 'results.json'), 'w') as file:
