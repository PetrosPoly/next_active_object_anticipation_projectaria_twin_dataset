...
time_thresholds = [1] # [1, 2, 3, 4, 5]          # Me: how many seconds before interaction activate LLM
...
for parameters in param_combinations: # TODO parallel 4 loop
    ...
    def main():
        ...
        for timestamp_ns in tqdm(img_timestamps_ns):
            ...
            # HIGH DOT / LOW DISTANCE / TIME COUNTERS - DICTIONARIES {NAME: COUNT}
